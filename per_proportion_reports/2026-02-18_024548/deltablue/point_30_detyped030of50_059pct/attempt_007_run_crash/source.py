    ...
    def make_plan(self, _sources):
        ...
        while clen(cast(CheckedList[Constraint], todo)):
            ...
            if c.output().mark != mark and c.inputs_known(mark):
                ...
                c.output().mark = mark
                self.add_constraints_consuming_to(c.output(), cast(CheckedList[Constraint], todo))
        return plan
    ...
    def add_propagate(self, _c, _mark):
        ...
        while clen(cast(CheckedList[Constraint], todo)):
            ...
            if d.output().mark == mark:
                ...
                return box(cbool(False))
            d.recalculate()
            self.add_constraints_consuming_to(d.output(), cast(CheckedList[Constraint], todo))
        return box(cbool(True))
