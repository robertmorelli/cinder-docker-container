...
class Planner(object):
    ...
    def incremental_remove(self, constraint: Constraint) -> None:
        ...
        unsatisfied = self.remove_propagate_from(cast(Variable, out))
        strength = REQUIRED
        repeat = True
        while repeat:
    ...
    # detyper-status: types_removed
    def remove_propagate_from(self, _out) -> CheckedList[Constraint]:
    ...
    # detyper-status: types_removed
    def add_constraints_consuming_to(self, _v, coll: CheckedList[Constraint]):
